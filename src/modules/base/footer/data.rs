...
impl Data {
    ...
    pub fn get_social_items(&self) -> Vec<SocialItem>  {
        vec![
            SocialItem {
                href: "https://www.linkedin.com/in/adrianardizza/".to_string(),
            ...
            SocialItem {
                href: "https://github.com/Meta502/".to_string(),
